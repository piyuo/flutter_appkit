...
const CmdTokenLogin$json = const {
  '1': 'CmdTokenLogin',
  '2': const [
...
final $typed_data.Uint8List cmdTokenLoginDescriptor = $convert.base64Decode('Cg1DbWRUb2tlbkxvZ2luEiIKDHJlZnJlc2hUb2tlbhgBIAEoCVIMcmVmcmVzaFRva2Vu');
