...
extension StringHelpers on String {
  ...
  /// ```
  DateTime get parseDate => DateFormat.yMMMMd().parse(this);

  /// parseDateTime parse string to date and time
  /// ```dart
  /// expect('January 2, 2021 11:30 PM'.parseDateTime.year, 2021);
  /// ```
  DateTime get parseDateTime => DateFormat.yMMMMd().add_jm().parse(this);

  /// parseTime parse string to time
  /// ```dart
  /// '11:30 PM'.parseTime;
  /// ```
  DateTime get parseTime => DateFormat.jm().parse(this);
}
