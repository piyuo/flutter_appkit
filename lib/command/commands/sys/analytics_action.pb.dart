...
import 'package:libcli/command/commands/google/timestamp.pb.dart' as $0;

class AnalyticsAction extends command.ProtoObject {
  $core.int mapIdXXX() {
    return 1001;
  }
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AnalyticsAction', createEmptyInstance: create)
  ...
  factory AnalyticsAction.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AnalyticsAction.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  AnalyticsAction clone() => AnalyticsAction()..mergeFromMessage(this);
  AnalyticsAction copyWith(void Function(AnalyticsAction) updates) => super.copyWith((message) => updates(message as AnalyticsAction));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AnalyticsAction create() => AnalyticsAction._();
  AnalyticsAction createEmptyInstance() => create();
  static $pb.PbList<AnalyticsAction> createRepeated() => $pb.PbList<AnalyticsAction>();
  @$core.pragma('dart2js:noInline')
  static AnalyticsAction getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AnalyticsAction>(create);
...
class Error extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set errid($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
