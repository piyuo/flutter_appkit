...
import 'package:libcli/command/commands/google/type.pb.dart' as $0;
import 'package:libcli/command/commands/google/source_context.pb.dart' as $1;

import 'package:libcli/command/commands/google/type.pbenum.dart' as $0;
...
class Api extends command.ProtoObject {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Api', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..e<$0.Syntax>(7, 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $0.Syntax.SYNTAX_PROTO2, valueOf: $0.Syntax.valueOf, enumValues: $0.Syntax.values)
