...
import 'package:libcli/command/commands/google/source_context.pb.dart' as $0;
import 'package:libcli/command/commands/google/any.pb.dart' as $1;

import 'type.pbenum.dart';

export 'type.pbenum.dart';

class Type extends command.ProtoObject {
  $core.int mapIdXXX() {
    return 1012;
  }
