...
class GeoSuggestions extends pb.Object {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GeoSuggestions',
      createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionToken',
        protoName: 'sessionToken')
    ..pc<$0.GeoSuggestion>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', $pb.PbFieldType.PM,
        subBuilder: $0.GeoSuggestion.create)
  ...
  factory GeoSuggestions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GeoSuggestions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  GeoSuggestions copyWith(void Function(GeoSuggestions) updates) =>
      super.copyWith((message) => updates(message as GeoSuggestions))
          as GeoSuggestions; // ignore: deprecated_member_use
