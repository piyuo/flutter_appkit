...
class CmdAutoComplete extends pb.Object {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CmdAutoComplete',
  ...
  factory CmdAutoComplete.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CmdAutoComplete.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CmdAutoComplete copyWith(void Function(CmdAutoComplete) updates) =>
      super.copyWith((message) => updates(message as CmdAutoComplete))
          as CmdAutoComplete; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static CmdAutoComplete getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CmdAutoComplete>(create);
