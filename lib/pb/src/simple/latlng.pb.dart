...
class Latlng extends pb.Object {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Latlng',
  ...
  Latlng copyWith(void Function(Latlng) updates) =>
      super.copyWith((message) => updates(message as Latlng)) as Latlng; // ignore: deprecated_member_use
