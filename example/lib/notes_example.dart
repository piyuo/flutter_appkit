...
import 'package:libcli/notes/notes.dart';
...
Widget _noteItem(BuildContext context, String id) {
  return MultiProvider(
      ...
      child: Consumer2<NoteFormController<sample.Person>, data.IndexedDbProvider>(
          builder: (context, formController, sampleDb, _) => Scaffold(
                  ...
                  builder: (isReady) => SafeArea(
                    child: Center(
                      child: NoteForm<sample.Person>(
                        formController: formController,
                        onWillPop: (formGroup, didPop) async => formController.isAllowToExit(),
                      ),
                    ),
                  ),
                ),
