...
import 'package:libcli/delta/delta.dart';
        ...
        child: Consumer<ValueNotifier<bool>>(builder: (context, model, child) {
            ...
            return Wrap(
              ...
              children: [
                WebVideo(
                  ...
                  height: 200,
                  onVideoLoaded: (video) =>
                      debugPrint('video loaded width:${video.size.width} height:${video.size.height}'),
                ),
                const WebVideo(
                  url: 'https://download.samplelib.com/mp4/sample-5s.mp4',
                  width: 360,
          ...
          return testing.ExampleScaffold(
            ...
            buttons: [
              ...
              testing.ExampleButton('search trigger', builder: searchTrigger),
              testing.ExampleButton('is touch enabled?', builder: isTouchSupported),
              testing.ExampleButton('no data', builder: noData),
              testing.ExampleButton('shimmer', builder: shimmer),
              testing.ExampleButton('AnimatedBadge', builder: animatedBadge),
              testing.ExampleButton('countdown', builder: countdown),
              testing.ExampleButton('search box', builder: searchBox),
              testing.ExampleButton('refresh button', builder: refreshButton),
              testing.ExampleButton('indicator', builder: indicator),
              testing.ExampleButton('tap breaker', builder: tapBreaker),
              testing.ExampleButton('qr image', builder: qrImage),
              testing.ExampleButton('web image', builder: webImage),
              testing.ExampleButton('single image', builder: singleImage),
              testing.ExampleButton('web video', builder: webVideo),
              testing.ExampleButton('checkbox', builder: checkbox),
              testing.ExampleButton('status light', builder: statusLight),
              testing.ExampleButton('switch', builder: switching),
              testing.ExampleButton('segment', builder: segment),
              testing.ExampleButton('error label', builder: errorLabel),
              testing.ExampleButton('side panel', builder: sidePanel),
              testing.ExampleButton('listing', builder: listing),
              testing.ExampleButton('check list', builder: checkList),
              testing.ExampleButton('VerticalOnPhoneLayout', builder: verticalOnPhoneLayout),
              testing.ExampleButton('padding to center', builder: paddingToCenters),
              testing.ExampleButton('wrapped-list-view', builder: wrappedListView),
              testing.ExampleButton('responsive', builder: responsive),
              testing.ExampleButton('shifter', builder: shifter),
              testing.ExampleButton('AnimateSliverList', builder: animateSliverList),
              testing.ExampleButton('animated grid', builder: animatedGrid),
              testing.ExampleButton('animated view in list', builder: animatedViewInList),
              testing.ExampleButton('animated view in grid', builder: animatedViewInGrid),
              testing.ExampleButton('animated view in list view', builder: animatedViewInListView),
              testing.ExampleButton('axis animate', builder: axisAnimate),
              testing.ExampleButton('transform container', builder: transformContainer),
            ],
          );
        }));
  }
